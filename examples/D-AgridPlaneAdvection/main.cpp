...
int main(int argc, char* argv[])
{
    ...
    // mesh initialization
    IceMesh* mesh_plane = new IceMesh(PLANE_PATH, mesh::surfType::plane, mesh::gridType::Agrid); 
    ...
    mesh_plane->SaveVTU("AgridAdvectionPlane", 0);
    ...
    {   
        ...
        if ((stepnum % 10 == 0) or (stepnum == (n_steps-1)))
        {
            ...
            mesh_plane->SaveVTU("AgridAdvectionPlane", stepnum);
        }
        BARRIER
    }
	return 0;
