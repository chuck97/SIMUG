...
namespace SIMUG
{
    ...
    struct IceConsts
    {
        ...
        static constexpr double C = 20;           // ice concentration parameter in pressure defenition value(-)
        static constexpr double pstr = 27.5e3;    // p* coefficient in pressure defenition value (N m-2)
        static constexpr double e = 2;            // eccentricity of VP elliptic yield curvee (-)
